...
urlpatterns = [
    ...
    path('register/verifing-account/', UserAccountVerificationView.as_view(), name='verifing'),
    path("activation/resend/", ActivationResendView.as_view(), name="activation-resend",),
